...
════════════════════════════════════════════════════════════════════════════
 ★★★ 2026-08-15 第一次跑出来的结果 —— 它把上面那两个数**都推翻了**
   ...
   (另一轮:0.8s -> 5.7s · 12.1s -> 5.9s · 24.1s -> 5.8s;`cpu_threads` 4/16/默认无差别)
   ...
   **③ 于是「按住说话好不好用」这个问题今天的答案是:松手之后要等 5.4–7.6 秒,
      而且你说得越短、等得越不值。** 方案书 :472 那个招牌例子
      (随口一句「记一下,下周要交房租」,约 2 秒)正好落在**最差**的那一格。
