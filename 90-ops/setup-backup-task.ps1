...
#
#  ★ 在【你自己的管理员 PowerShell】里跑。
#  ★★ 不是"只需跑这一次"(2026-07-31 审计更正):计划任务把 ai-mem 密码存在 Task Scheduler 里,
#     而 install-postgres/qdrant/embedding、apply-schema 会重置 ai-mem 密码 —— 跑过它们之后
#     本任务的凭据就失效(登录 0x8007052E),下次备份必失败。那四个脚本现在会顺手刷新本任务凭据;
#     但若备份仍报凭据失效,重跑本脚本即可。
#
