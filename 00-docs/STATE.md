...
> **客户端 selftest 562**(外壳 30 → 主页 224 → 聊天/项目/存储/共享全套 562)
>
...
| **P3c 统一客户端** | 🔵 **进行中(2026-07-30)** —— S0 选型 ✅(D47 WPF)· S1 成员层 ✅(14/14)· S2 管理面 ✅(15/15,仅回环 D48)· S3 WPF 外壳 ✅· S1b 证书续签 ✅(13/13,D49)· **主页 ✅** · **聊天 + 项目体系 ✅** · **本地落盘 ✅(D50)** · **D45 过滤实装 ✅** · **分层存储 / 记忆库 / 存储清理 ✅** · **共享模型 ✅(D52)** —— 客户端 selftest **562 全绿**。**剩:** 🔵 **翻译工作空间(本轮要做)** · 🔵 **桌面宠物(本轮要做)** · S4 配对界面接回环管理面【跑实机】· S5 显存释放接 gpu-broker(P4 内核)· 其余四个工作空间(资产/课程/电脑控制/财务/投资 —— 用户裁定**等这三块搭好再回来**)· 各板块接真实数据源(依赖 P4 / Apple 接入)· **数据「来源 × AI 可读/可操作 × 回滚」矩阵**(待设计定稿,见待决) |
